function [results, states_save]...
    =Call_Function_TDTHMM_nomean_application(data, burnin, nmc, S, v0, v1, pii, nu, a_alpha, b_alpha, K_sb, disp_result)
%% Outputs
...
temp=repelem(1:S, 100); % equally divide into S parts
states = temp;
for ii = 1:floor(T/100)
    states = [states, temp];
end
states=states(1:T);
