...
function parsave(results, states_save, tau_t_save, pii)  %%% Set up the names here
    save(['Application_results/gesture_result_pii', num2str(pii)],'results')
    save(['Application_results/gesture_result_pii', num2str(pii),'_tau'],'tau_t_save')
    save(['Application_results/gesture_result_pii', num2str(pii),'_states'],'states_save')
end
