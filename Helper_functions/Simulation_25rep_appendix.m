%% Compare model performances, p = 10
...
% graphical model, the Dinamic Dirichlet-t graphical model
...
mkdir('Simulation_results_appendix') % MCMC results are saved in the Simulation_results folder
