...
# for (coreind in 1:ncore)
{
  ...
  for (jj in 1:nrun) {
    ...
    cur_filename <- paste('Synthetic_data_appendix/Synthetic_data_', data_method,'_rep_', rep,'.mat', sep = '')
    ...
    cur_theta_filename <- paste('Simulation_results_appendix/results_sim_', data_method,'_FGL_C_rep_', rep,'.csv', sep = '')
    ...
    cur_theta_filename <- paste('Simulation_results_appendix/results_sim_',data_method,'_FGL_adj_rep_', rep,'.csv', sep = '')
    ...
    cur_perf_filename <- paste('Simulation_analysis_appendix/perf_',data_method,'_FGL_avg_rep', rep,'.csv', sep = '')
    write.table(t(c(perf_summary[1], perf_summary[2], perf_summary[3], max(auc_fgl),
                ...
                col.names = FALSE, sep = ",")
    cur_perf_filename <- paste('Simulation_analysis_appendix/perf_',data_method,'_FGL_roc_rep', rep,'.csv', sep = '')
